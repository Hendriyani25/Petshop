  ...
  <div class="container-fluid">   
      <div class="row align-items-center">  
        ...
        <div class="col-md-6" id="col6">
        	...
        	<div>
            <h6 class="flex-grow text-center">SELAMAT!<br>Silahkan cek email Anda<br>untuk mendapatkan password baru</h6>
        	</div>
        	<div class="d-flex flex-row-reverse mt-3" id="divbtn">
        		<button class="btn rounded-pill px-3 text-white ms-3" id="btnemail">Kembali ke halaman login</button>
        	</div>
        </div>
      </div>
  </div>
