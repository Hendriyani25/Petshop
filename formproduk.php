      ...
      <div class="card p-3">
        <div class="row">
          ...
          <div class="col-6 text-end">
            <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#modaltambahproduct"><span class="material-icons-outlined">post_add</span>Tambah Produk</button>
          </div>
        </div>
